...
function Prototype() {
    return (
        <div className="prototype">
             ...
             text1={'De VerderKijker staat gericht naar een stuk natuur toe'}
             text2={'Als je de VerderKijker gebruikt kan je rondkijken, je zit aan het stipje waar je precies naar kijkt'}
             text3={'Als de gebruiker naar een boom kijkt geeft het stipje een indicatie van hoelang je hiernaar moet kijken'}
             text4={'Zodra het laadbalkje vol is laat de VerderKijker informatie in AR zien aan de gebruiker over deze plantensoort'}/>
             <Scenario title={'Scenario B'} imagenr={5}
             text1={'De VerderKijker staat gericht naar een stuk natuur toe. Vervolgens projecteerd hij een dier die in dit gebied voorkomt'}
